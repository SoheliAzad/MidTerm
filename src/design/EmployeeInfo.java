...
public class EmployeeInfo extends AbstractClass {
	...
	public static int calculateEmployeeBonus(int numberOfYearsWithCompany, double yearlySalary) {
		...
		if (numberOfYearsWithCompany == 5) {
			...
			yearlyBonus = 0;
			System.out.println("You have rooms to develop,read your appraisal form to know about required training need.");
		} else {
			yearlyBonus = 0;
			System.out.println("You are not entitled to receive bonus as of now.");
		}
